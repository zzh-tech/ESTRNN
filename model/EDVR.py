...
from .arches import ResidualBlockNoBN, make_blocks as make_layer, ModulatedDeformLayer as DCNv2Pack
...
class Model(nn.Module):
    """
    EDVR: Video Restoration with Enhanced Deformable Convolutional Networks (EDVR, CVPR2019)
    """

    def __init__(self, para):
        super(Model, self).__init__()
        assert para.frames == 5 and para.future_frames == 2 and para.past_frames == 2, "EDVR takes 5 frames as input"
        num_frame = para.future_frames + 1 + para.past_frames
        self.net = EDVR(num_frame=num_frame, with_predeblur=True, hr_in=True)
